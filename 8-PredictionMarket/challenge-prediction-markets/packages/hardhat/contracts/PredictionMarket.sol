...
contract PredictionMarket is Ownable {
    ...
    function resolveMarketAndWithdraw() external onlyOwner predictionReported returns (uint256 ethRedeemed) {
        ...
        uint256 totalEth = ethRedeemed + s_lpTradingRevenue;
        ...
        emit MarketResolved(msg.sender, totalEth);
    ...
    function _calculatePriceInEth(
        ...
        uint256 otherTokenSoldBefore = totalTokenSupply - currentOtherTokenReserve;

        uint256 totalTokensSoldBefore = currentTokenSoldBefore + otherTokenSoldBefore;
